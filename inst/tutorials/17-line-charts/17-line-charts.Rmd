...
So what story does this tell? Looks like before the pandemic, unemployment was humming along reasonably stable, and then boom. The pandemic hits and the unemployment rate balloons. Then, after a bit, it returns to more normal ranges. That gap in the data? It was when the lengthy government shutdown happened. You'll see it again soon.  
