...
Let's look at how unemployment changed over the the last five years -- from before the pandemic until more recent months. First thing we'll do is take a look at our data. You should see a problem right away. 
...
In this case, adding a layer is very easy. The reason? We're adding a layer with just your state in it. So this new layer is identical to your `national` layer with two small changes -- your dataframe name is your state dataframe we used in exercise 3. And instead of grey, we're going to make it red, so it stands out from the pack. 
