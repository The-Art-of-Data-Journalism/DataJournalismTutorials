...
It's hard to explain to people who have never worked with data how important the simple act of count is. Almost every data story you will ever work on will have a count in them -- either one you will do or one done for you before you get the data. Almost every data story can be summarized into a few questions:

- How many of this thing are there where I live?
- How many of those things were there last year? Or five years ago?
- How does that many thing compare to my state? The nation?
...
### Exercise 5: Tally, but arranged this time
