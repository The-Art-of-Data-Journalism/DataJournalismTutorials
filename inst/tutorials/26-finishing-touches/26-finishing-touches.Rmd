...
If you're a student of journalism, and you've taken your studies seriously, you've hopefully learned by now that often the most direct path to better writing is taking stuff out.
...
"Just as a good editor of prose ruthlessly prunes out unnecessary words, so a designer of statistical graphics should prune out in that fails to present fresh data-information," Tufte wrote in his 1983 work The Visual Display of Quantitative Information. "Although nothing can replace a good graphical idea applied to an interesting set of numbers, editing and revision are essential to sound graphical design work as they are to writing." 
