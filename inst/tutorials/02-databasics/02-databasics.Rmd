...
So the names of every county in this dataset are in the `CTYNAME` column. Want to know what county has the most people? You'll need the `POPESTIMATE2025` column. Looking at that first row for those names is something you're going to do over and over again. 
