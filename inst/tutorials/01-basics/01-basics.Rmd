...
biggest <- census |> filter(POPESTIMATE2025 == max(POPESTIMATE2025))
...
pctchange <- (biggest$POPESTIMATE2025 - biggest$POPESTIMATE2024)/biggest$POPESTIMATE2024

natchng <- biggest$BIRTHS2025 - biggest$DEATHS2025
```
## The Goal
...
glue("As of the latest estimates, {biggest$CTYNAME} had {biggest$POPESTIMATE2025} in 2025 and {biggest$POPESTIMATE2024} in 2024. Fill in numbers into the formula and you'll be able to tell your editor how much {biggest$CTYNAME} changed in one year.") 
```
