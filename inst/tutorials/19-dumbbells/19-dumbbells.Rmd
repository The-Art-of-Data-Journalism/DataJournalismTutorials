...
Coulter Jones has worked in tiny newspapers, trade publications and in public radio. He's also worked at two of the largest news organizations in the world in Bloomberg News and the Wall Street Journal. In smaller places, it's much more common for someone with some data skills to take a graphic all the way to publication. But Bloomberg and the WSJ have graphics staffs larger than most newspapers these days. There's zero chance of Jones turning some data he has into a graphic that faces the public.
...
"One of the things that I did not appreciate at first, but then like quickly learned to love about R is like, oh, this is a visual platform too," Jones said. "So I can very easily just do histogram. I can do like a two factor line or point, sort of like show me age and sex or something like that.

"If you just chart it, you can sometimes like just see the story immediately."
...
Well, that's a chart alright, but did you get a warning? Not to worry -- that's an issue in `ggalt`, nothing you did. But with what you *did* do, what dot is the in-state tuition and what the out of state? To fix this, we'll add colors.
