...
totals <- crashes |> 
  ...
  tally() |> 
  ungroup() |> 
  filter(floor_year == as.Date("2025-01-01"))
```
## The Goal
...
glue("A paragraph you can write about plane crashes: In {stateName$State}, there's been {nrows} airplane accidents investigated by the National Transportation Board since 2019. In 2025, there were {totals[2]}.")
```
